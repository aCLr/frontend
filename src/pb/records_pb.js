...
goog.exportSymbol('proto.records.RecordsQuery', null, global);
/**
...
proto.records.GetRecordsListRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    query: jspb.Message.getFieldWithDefault(msg, 5, 0)
  };
...
proto.records.GetRecordsListRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = /** @type {!proto.records.RecordsQuery} */ (reader.readEnum());
      msg.setQuery(value);
      break;
    default:
      reader.skipField();
...
/**
 * optional RecordsQuery query = 5;
 * @return {!proto.records.RecordsQuery}
 */
proto.records.GetRecordsListRequest.prototype.getQuery = function() {
  return /** @type {!proto.records.RecordsQuery} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};


/**
 * @param {!proto.records.RecordsQuery} value
 * @return {!proto.records.GetRecordsListRequest} returns this
 */
proto.records.GetRecordsListRequest.prototype.setQuery = function(value) {
